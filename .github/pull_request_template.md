...
- [ ] Si el cambio toca un canal sin activar (WhatsApp, guía descargable, GA4, Turnstile, `/admin`): sigue construido pero sin activar — ver `src/data/channels.js` y `.env.example`.
